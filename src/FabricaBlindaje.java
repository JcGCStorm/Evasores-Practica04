/**
 * Fabrica de Blindajes, extiende a {@link AbstractFactory} por lo que sobreescribe su metodo
...
public class FabricaBlindaje extends AbstractFactory{
    ...
    /**
     * Metodo getComponente que sobreescribe al metodo homonimo de la clase abstracta
     * {@link AbstractFactory}, este nos devuelve el tipo de componente de la nave, en este caso
     * nos devuelve el <i>blindaje</i> según la decisión del cliente. En este metodo hacemos uso del 
     * metodo <code>getBlindaje()</code> que nos devuelve el <>b>blindaje</b> de la nave del cliente.
    ...
    /**
     * Metodo getBlindaje que nos devuelve un blindaje en especifico según la elección del cliente.
     * Recibe un tipo de <b>blindaje</b> en una {@link String} y nos devuelve un objeto de tipo 
     * {@link Blindaje}
     * @param tipoBlindaje
